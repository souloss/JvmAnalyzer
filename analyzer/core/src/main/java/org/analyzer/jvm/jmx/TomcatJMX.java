...
public class TomcatJMX {
    ...
    public static void main(String[] args) {
        try {
            String jmxURL = "service:jmx:rmi:///jndi/rmi://192.168.31.128:7999/jmxrmi";// tomcat jmx url
            // String jmxURL = "192.168.31.128:7999/jmxrmi";// tomcat jmx url
            //
            ...
            // ObjectName("Catalina:type=Connector,port=8080");
            ...
            // System.out.println("厂商:" + (String) mbsc.getAttribute(runtimeObjName,
            // "VmVendor"));
            // System.out.println("程序:" + (String) mbsc.getAttribute(runtimeObjName,
            // "VmName"));
            // System.out.println("版本:" + (String) mbsc.getAttribute(runtimeObjName,
            // "VmVersion"));
            ...
            // MemoryUsage nonheapMemoryUsage = MemoryUsage.from((CompositeDataSupport)
            // mbsc.getAttribute(heapObjName,
            // "NonHeapMemoryUsage"));
            ...
            // Gen");
            // MemoryUsage permGenUsage = MemoryUsage.from((CompositeDataSupport)
            // mbsc.getAttribute(permObjName, "Usage"));
    ...
    public static void getSession(MBeanServerConnection mbsc) throws Exception{
    ...
    public static void getThreadPool(MBeanServerConnection mbsc) throws Exception{
